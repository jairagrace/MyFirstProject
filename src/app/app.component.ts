...
export class AppComponent {
  ...
  addStudentEntry():Boolean{
    ...
    if(this.checkPatterns(this.studNo,studNumberPattern)&& this.checkPatterns(this.studFname,stringPattern) && this.checkPatterns(this.studLname,stringPattern) && this.checkPatterns(this.studProg,stringPattern) && this.checkPatterns(this.studYr,studYearPattern))
      {
        this.studentRecord = {
      ...
      this.messages = 'Errors has been encountered and therefore cannot continue to process requested operations';
      return false;
    }
  }
